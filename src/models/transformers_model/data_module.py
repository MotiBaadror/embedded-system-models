...
class GLUEDataModule(pl.LightningDataModule):
    ...
    def prepare_data(self, sms_data=True):
        ...
        splits = dataset.train_test_split(test_size=0.4, shuffle=True, seed=42)
        splits_val_test = splits['test'].train_test_split(test_size=0.5,shuffle=True,seed=42)

        self.dataset = datasets.DatasetDict({
            'train':splits['train'],
            'test':splits_val_test['train'],
            'val': splits_val_test['test']
        })
